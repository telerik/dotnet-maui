...
namespace Microsoft.Maui.DeviceTests.Stubs
{
	public class ApplicationStub : Application
	{
		...
		{
			// Base only sets ApplicationCurrent if "true" is passed (the default)
			// It seems easier to revert this here instead instead of authoring Reflection to call the internal base constructor.
