if (IsMac)
{
	...
	AppleCodesignIdentity("Apple Development: Rui Marinho (G6DXESA369)", "https://dl.internalx.com/internal-files/test/certs/maui-mac-ios-certificate.p12");
	AppleCodesignProfile("https://dl.internalx.com/internal-files/test/certs/maui-ios-provisioning.mobileprovision");
	AppleCodesignProfile("https://dl.internalx.com/internal-files/test/certs/maui-mac-provisioning.mobileprovision");
